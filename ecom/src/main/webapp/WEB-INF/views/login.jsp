...
<body>
   ...
   <script src="<c:url value="/resources/fakeLoader/insertLoader.js" />"></script>
        ...
        <!-- header -->
 		...
 		<input type="hidden" id="val" value="${LoggedIn.getStatus()}" /> 

<div class="login-form" style="margin-top:50px;margin-bottom: 50px;">
  ...
  <!-- footer -->
       ...
       <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.9/umd/popper.min.js" integrity="sha384-ApNbgh9B+Y1QKtv3Rn7W3mgPxhU9K/ScQsAP7hUibX39j7fakFPskvXusvfa0b4Q" crossorigin="anonymous"></script>
 		<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js" integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl" crossorigin="anonymous"></script>
 		 ...
 		 if($("#val").attr("value") == "Invalid Account")
 		 { 
 			var newItem = '<div class="alert alert-danger alert-dismissible fade show" role="alert"> <strong>Invalid Account!</strong> <a style="margin-left: 10px;" href="#"><u>Gerbuikersnaam of wachtwoord klopt niet</u></a><button type="button" class="close" data-dismiss="alert" aria-label="Close" style="font-size: 20px;"> <span aria-hidden="true">×</span></button> </div>';
         	$(".login-form").prepend(newItem); 
 		 }
 		 </script>
