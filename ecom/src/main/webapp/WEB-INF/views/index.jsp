...
<body>
   ...
   <script src="<c:url value="/resources/fakeLoader/insertLoader.js" />"></script>
		...
		<div id="beff" align="center" style="margin-top:50px;margin-bottom: 50px;">
			...
			<h1>Book Manager Application</h1>
			<h3>
				<a href="./admin/nieuw" style="color: red;">New Book</a> | 
				<a href="./admin/aankopen" style="color: red;">Bestellingen</a>
			</h3>
			...
			<table  >
				...
				<c:forEach var="boeken" items="${listBoeken}">
				
					<tr>
					 	<td>${boeken.id}</td>
						<td>${boeken.titel}</td>
						<td>${boeken.auteur}</td>
						<td>${boeken.afbeelding}</td>
						<td>${boeken.omschrijving}</td>
						<td>
							<a style="color: red;" href="./admin/edit?id=${boeken.id}">Edit</a>
						</td>
					</tr>
				</c:forEach>
			</table>
